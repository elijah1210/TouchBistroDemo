...
const sieveNumberHandler = (req, res) => {
	...
	const output = helper.medianCalc(helper.eratosCalc(sieveNumber));
...
module.exports = {clientErrorHandler, medianCalc, eratosCalc, sieveNumberHandler, defaultRouteHandler}